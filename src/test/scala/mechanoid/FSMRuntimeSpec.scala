...
object FSMRuntimeSpec extends ZIOSpecDefault:
  ...
  /** PostgreSQL store for integration tests. */
  val xaLayer: ZLayer[Any, Any, Transactor] =
    PostgresTestContainer.DataSourceProvider.default >>> Transactor.default

  val postgresStoreLayer: ZLayer[Any, Any, EventStore[String, OrderState, OrderEvent]] =
